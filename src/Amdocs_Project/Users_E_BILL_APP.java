...
public class Users_E_BILL_APP {
    ...
    public static void checkUserProfile(String usernamedb, String pass) {
        ...
        String targetPassword = scan.nextLine();
         while(targetPassword.trim().isEmpty())
         {
        	 System.out.println("Dont enter empty password");
        	 targetPassword=scan.nextLine();
